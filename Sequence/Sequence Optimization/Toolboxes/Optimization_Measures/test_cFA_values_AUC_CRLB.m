...
testDict             = 'JUSTdict';             % RF profile | 'SLR_Prof' OR 'JUSTdict'
...
if testDict == 'JUSTdict'
    ...
    T2_ini  = [   8      45        83     45  ];
    TE_ini  = [   6.4     6.4      9     13.8];
    ETL_ini = [  12      18        12      5  ];
    FA_ini  = [ 125     123       158    180  ];
    TR_ini  = [2160    3116      3041   2057  ];
elseif testDict == 'SLR_Prof'
    T1_ini  = [ones(1,2)*1000    1445  1000  ];
    T2_ini  = [   8       45       83    45  ];
    TE_ini  = [   6.40     6.50     9    13.8];
    ETL_ini = [  18       18       12     5  ];
    FA_ini  = [ 123      124      158   180  ];
    TR_ini  = [3120     3160      3041 2057  ];
end
...
for jj=1:size(T1_ini,2)
    ...
    plot(timeVector{jj},signal{jj}','linewidth',2)
    xlabel('Time (ms)')
    hold on
end
xline(45*1.5)
...
legend(['Short | 8    (ms)'],['Knee | 45   (ms)'],['GM   | 83   (ms)'],['Knee (Study) | 45   (ms)'],['Measure of AUC for 150% of T2=45 (ms)'])
