...
function [b1Plus_rms,T_scan_s] = b1rms4seq_optFSE(Sample_weight,TE,TR,ETL,vector_flipAngle,st,nsli,res, display)
...
% Get time
Trec  = RFexcDur + (TE/2- RFexcDur/2) + TE * ETL + t_gs4 + t_gs5 + t_spoiler;  % (ms)
TRmin = Trec * nsli;                                                           % (ms) 
