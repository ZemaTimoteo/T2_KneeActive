...
function [vardT2, ds_dT2, FF_tool, factorFPB_epg] = CRLB_epg_optFSE_TRvar_testParametersFORfmincon(rf_exc, B1, T1, T2, dTE, ETL, TRacq, T_scan, Trec, flipA, sigma, plotTest,testFBP, dir_data, methodDic)
...
test_value = (factorFPB_epg^2 )*sqrt(T_scan) / (sigma^2) / (TRacq);
