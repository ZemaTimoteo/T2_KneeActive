function [obj, grad, FF]  = auxOptimiz_obj_EPG13_T2_test4(params,exc_puls,refoc_puls,ESP,ETL,T1,T2,Adj_stat,B1,frequencies,klim,Trec,Trec_Contrl,testPlot)
