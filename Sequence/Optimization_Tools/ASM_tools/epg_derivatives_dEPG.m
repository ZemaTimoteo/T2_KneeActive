function [ds_dT2,ds_dFl,epg] = epg_derivatives_dEPG(alpha_RF , alpha, n, nRates, R1, R2vec, tau, S)
...
% % %     RArray_full    = cell(1,n);    
% % %     RArray_full(:) = {(R0)};
% % %     R_full         = blkdiag(exp(-tau*R2),RArray_full{:});
