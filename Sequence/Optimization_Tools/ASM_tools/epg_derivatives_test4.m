...
function [ obj, grad, FF ] = epg_derivatives_test4( n, tau, R1, R2vec, alpha_RF, alpha )
...
% teste 29/4
% % figure; subplot(121); plot(abs(FF))
% % title('Non-norm, Method tlb.-SLR90+rect, exc=0.0172')
% % subplot(122); plot(abs(FF./norm(FF)))
% % title('Norm, Method tlb.-SLR90+rect, exc=0.0172')
