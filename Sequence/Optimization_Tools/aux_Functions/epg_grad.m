...
FpFmZ(1,:) = circshift(FpFmZ(1,:),[0 1]);	% Shift Fp states. - %CIRCSHIFT Shift positions of elements circularly.
FpFmZ(2,:) = circshift(FpFmZ(2,:),[0 -1]);	% Shift Fm states. - %CIRCSHIFT Shift positions of elements circularly.
