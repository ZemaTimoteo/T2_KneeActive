function [dictionary,pars] = dict_pars_generator_TRvar(T1,T2,B1,ESP, ETL,refoc_phase,phase_exc,FA_exc,FA_refoc,dir_data,Trec)
...
% %         [exc_pulse, refoc_pulseSLR] = slr_profile_vF(FA_exc,B1(jj),FA_refocUNIQUE(ii),dir_rf);
% %         refoc_pulse                 = [refoc_pulse refoc_pulseSLR(:)];
        clear refoc_pulseSLR
    end
        
    Dict = my_epg_TRvar(exc_pulse,refoc_pulse,phase_exc,refoc_phase,T1,T2,ESP,ETL,Trec);
