function [Dict, echoes]= my_epg_TRvar_test2(exc_pulse,refoc_pulse,exc_phase,refoc_phase,T1,T2,dTE,ETL,Trec)
...
% %         title('Non-norm, Method myEPG-SLR90 + Rect, exc=0.0172')
% %         subplot(122); plot(abs(s./norm(s)))
% %         title('Norm, Method myEPG-SLR90 + Rect, exc=0.0172')
        
    end
end

% teste 5 de Maio
% % load('teste050522.mat')
% % diff = echoes - s_epg;
% % figure(); plot(abs(diff'))
