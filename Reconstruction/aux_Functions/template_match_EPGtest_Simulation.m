function [ ind_X ] = template_match_EPGtest_Simulation( S,X,col_T2, col_B1 )
...
% Figures
figure();plot(inner_product)
Best_T2 = col_T2(ind_X);
Best_B1 = col_B1(ind_X);
hold on
title(['Best T2=', num2str(Best_T2), 'ms | Best B1=', num2str(Best_B1), ' %']);
