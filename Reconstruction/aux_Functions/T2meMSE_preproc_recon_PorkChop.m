...
%     - Complementary function of python code, recon GRAPPA and creates
%     NIFTI files for denoising and removing Gibbs rings with MRTRIX in
%     Linux.
% 
% by: TTFernandes, June 2022
...
maskTest     = 'True';
filterTest   = 'Fals';
ParallelTest = 'GRAPP'; % 'GRAPP' or 'SENSE'
PhantomTest  = 'Fals';  % Test if is Phantom or Porkshop
...
fprintf(['  --  MSE_preproc_recon_vf.m - Finnished!  -- \n\n'])
