    ...
    for jj in range(B1.shape[0]):
        ...
        if SLR:
            ...
            for ii in range(FA_refoc.shape[0]): # only accept one FA_refoc
                [exc_pulse, val_refoc_pulse] = slr_profile_seq_vJuly24(FA_exc,
                                                                       B1[jj],
                                                                       FA_refoc[ii][0],
                                                                       ST_exc,
                                                                       ST_refoc,
                ...
                refoc_pulse[:,ii] =  aux_refoc_pulse
                #plt.plot(aux_refoc_pulse)
        ...
        # ... 2.2 - slice profile without considering SLR profile ...
            ...
            # Constant FA &  Variable FA
            exc_pulse   = FA_exc   * B1[jj]
